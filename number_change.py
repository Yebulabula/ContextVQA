...
<span style="color:brown;">- Each description should clearly specify where the object(s) being added in a unique way. Ambigious or wrong descriptions will be </span> <span style="color:red;"> **rejected**.</span> 

<span style="color:red;"> Good Description: </span> Another red apple has been placed in the sink near the refrigerator. 
<span style="color:green;"> Bad Description: </span> Another apple has been placed in the sink. </span> (which apple, which table?)

<span style="color:brown;">- Each description should add different objects in the scene. </span>

<span style="color:brown;">- Each description should be more than 8 words. </span>
