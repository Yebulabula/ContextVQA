...
- A new bicycle has been added to the room, leaning against the gray couch along with a backpack.
...
<span style="color:brown;">- All object additions must occur within the same scene and be independent of one another. </span>
...
*Please use your imagination and creativity to come up with unique and interesting additions!*
"""
...
with right_col:
    ...
    st.markdown("<div style='font-weight: bold; font-size: 20px;'>Addition 1</div>", unsafe_allow_html=True)
    context_change = st.text_area("Describe a possible object Addition within the scene in details.", key="change1", placeholder="Type here...", height=10)
    
    st.markdown("<div style='font-weight: bold; font-size: 20px;'>Addition 2</div>", unsafe_allow_html=True)
    context_change = st.text_area("Describe a possible object Addition within the scene in details.", key="change2", placeholder="Type here...", height=10)
    
    st.markdown("<div style='font-weight: bold; font-size: 20px;'>Addition 3</div>", unsafe_allow_html=True)
    context_change = st.text_area("Describe a possible object Addition within the scene in details.", key="change3", placeholder="Type here...", height=10)
    
    st.markdown("<div style='font-weight: bold; font-size: 20px;'>Addition 4</div>", unsafe_allow_html=True)
    context_change = st.text_area("Describe a possible object Addition within the scene in details.", key="change4", placeholder="Type here...", height=10)
    
    st.markdown("<div style='font-weight: bold; font-size: 20px;'>Addition 5</div>", unsafe_allow_html=True)
    context_change = st.text_area("Describe a possible object Addition within the scene in details.", key="change5", placeholder="Type here...", height=10)
