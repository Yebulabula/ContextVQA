...
**Conside the example scene below, possible object removals can include:**
...
<span style="color:brown;">- Each description must clearly and uniquely specify the number of objects removed and their exact locations. Ambigious or wrong descriptions will be </span> <span style="color:red;"> **rejected**.</span> 
...
<span style="color:brown;">- Each description should remove different objects in the scene. </span>
