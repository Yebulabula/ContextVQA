...
scenes = sorted([scene_id for scene_id in os.listdir(ROOT_1) if scene_id.startswith('scene') and os.path.exists(f'/mnt/new_drive/Documents/scans/{scene_id}/{scene_id}_vh_clean.ply') and os.path.exists(f'/mnt/new_drive/Documents/scans/{scene_id}/{scene_id}_vh_clean_2.labels.ply')])
