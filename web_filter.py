...
<span style="color:red;"> Good Description: </span> The red apple on the table has been moved to the sink near to the refrigerator. 
<span style="color:green;"> Bad Description: </span> The apple has been moved to the sink. </span> (which apple, which sink?)
